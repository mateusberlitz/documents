...
export function SectionWithOverlappingBoxes(props: SelectBoxProps){
            ...
            isWideVersion ? (
                <Flex flexDir={["column","column","row","row"]}>
                    ...
                    <Box
                        ...
                        marginLeft={index === 1 && isWideVersion || index === 2 && isWideVersion ? "-90px" : "0px"}
                        marginRight={index === 1 && isWideVersion || index === 2 && isWideVersion ? "-90px" : "0px"}
...
export default SectionWithOverlappingBoxes;